                    ...
                    <tr>
                        <td class="hidden pb-4 md:table-cell">
                            <a href="{{ route('shop.show', $item->model->slug) }}">
                                <img src="{{ asset('img/products/product.jpg') }}" class="w-20 rounded" alt="Thumbnail">
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('shop.show', $item->model->slug) }}">
                                <p class="mb-2 md:ml-4">{{ $item->model->name }}</p>
                        ...
                        <div class="justify-center md:flex">
                            <form action="" method="POST">
                                <div class="flex items-center w-full h-13 pl-3 bg-white bg-gray-100 border rounded-full">
                                    <input type="coupon" name="code" id="coupon" placeholder="Apply coupon" value="90off" class="w-full bg-gray-100 outline-none appearance-none focus:outline-none active:outline-none" />
